                ...
                data: (tables) => Column(children: [
                  ...
                  Container(
                    ...
                    child: Row(children: [
                      ...
                      if (!_editMode) Text('Tap a table to open POS', style: TextStyle(fontSize: 11, color: context.cs.onSurfaceVariant)),
                    ]),
                  ),
                  // Canvas
                  Expanded(
...
// ═══════════════════════════════════════════════════════
// POS SCREEN — Complete order management
// ═══════════════════════════════════════════════════════
      ...
      appBar: AppBar(
        ...
        actions: [
          ...
          IconButton(icon: Icon(_showSearch ? Icons.close : Icons.search_rounded),
            ...
            onPressed: () => setState(() { _showSearch = !_showSearch; if (!_showSearch) { _search = ''; _searchCtrl.clear(); } })),
          // Order actions
          if (order != null) ...[
                          ...
                          if (g.iconPath.isNotEmpty)
                            Padding(
                              ...
                              child: ClipRRect(
                                ...
                                child: Image.file(File(g.iconPath), width: 18, height: 18, fit: BoxFit.cover,
